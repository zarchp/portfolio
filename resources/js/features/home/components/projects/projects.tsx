...
import { allProjects, featuredProjects } from '@/features/home/data/projects';
import type { ProjectProps } from '@/features/home/types/projects';
import { fadeInUp } from '@/lib/motion';
import { ChevronDown, Code } from 'lucide-react';
import { useMemo } from 'react';
import { useIncrementalTake } from '../../hooks/use-incremental-take';
...
export default function Projects() {
  const nonFeatured = useMemo<ProjectProps[]>(() => {
